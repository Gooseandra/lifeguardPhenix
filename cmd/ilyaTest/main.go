...
func main() {
	...
	contacts := models.NewUserContactsDefault("", "", "", "")
	name := models.NewUserNameDefault("", "", "", "root")
	userStorage.New(contacts, name, "", time.Now())
	...
	api.EraseUserHandler = handlers.NewFiredUser(logService, &sessionService, userService)
	api.GetUserHandler = handlers.NewGetUser(logService, &sessionService, userService)
	api.ListUsersHandler = handlers.NewListUser(&sessionService, logService, userService)
	api.UpdateUserHandler = handlers.NewUpdateUser(logService, &sessionService, userService)

	api.LoginHandler = handlers.NewLogin(&sessionService, logService, userService)
